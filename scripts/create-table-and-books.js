...
// DynamoDB 테이블 생성
async function createLearningResourcesTable() {
  console.log('📋 LearningResourcesTable 생성 중...');
  ...
  try {
    ...
    console.log('✅ LearningResourcesTable 생성 완료');
...
const kyoboBooks = [
  // ADsP 도서
  {
    ...
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000061352' },
  ...
  },
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      aladin: 'https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=319876543'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000201234' },
  ...
  },
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      yes24: 'https://www.yes24.com/Product/Goods/120123456'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000301234' },
  ...
  // ADP 도서
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      yes24: 'https://www.yes24.com/Product/Goods/121234567'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000401234' },
  ...
  },
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      aladin: 'https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=321234567'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000501234' },
  ...
  // SQLD 도서
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      yes24: 'https://www.yes24.com/Product/Goods/122345678',
      aladin: 'https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=322345678'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000601234' },
  ...
  },
  {
    ...
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000701234' },
  ...
  // SQLP 도서
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      aladin: 'https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=323456789'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000801234' },
  ...
  },
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      yes24: 'https://www.yes24.com/Product/Goods/124567890'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S000901234' },
  ...
  // DAsP 도서
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      aladin: 'https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=324567890'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S001001234' },
  ...
  },
  {
    ...
    purchaseLinks: { S: JSON.stringify({
      ...
      yes24: 'https://www.yes24.com/Product/Goods/125678901'
    })},
    accessUrl: { S: 'https://product.kyobobook.co.kr/detail/S001101234' },
...
if (require.main === module) {
  setupBooksDatabase().catch(console.error);
}

module.exports = { setupBooksDatabase };
